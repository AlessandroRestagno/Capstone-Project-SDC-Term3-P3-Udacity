...
class DBWNode(object):
    def __init__(self):
        ...
        #Publish to all the topics you need to
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in (self.velocity, self.twist):
                self.throttle, self.brake, self.steering = self.controller.control(self.twist, self.velocity, self.dbw_enabled)
            if self.dbw_enabled:
